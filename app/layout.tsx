...
export const metadata: Metadata = {
  title: "Certificate Vault - Secure Achievement Showcase",
  description: "Discover, collect, and showcase your professional certificates in a beautiful digital vault",
  generator: "v0.app",
  icons: {
    icon: [
      {
