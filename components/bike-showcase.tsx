            ...
            <div className="relative">
              ...
              <blockquote className="relative z-10 max-w-xl">
                <p className="text-4xl md:text-5xl lg:text-6xl font-black uppercase text-lorenzo-text-light leading-[1.1] tracking-tight mb-8">
                  <span className="block mb-2">I FOCUS ON</span>
                  <span className="block mb-2">CONTINUOUS</span>
                  <span className="block text-lorenzo-accent font-brier normal-case text-5xl md:text-6xl -ml-1 lg:text-8xl">
                    LEARNING
                  </span>
                  <span className="block mt-2">TO ACHIEVE</span>
              ...
              {/* Author attribution */}
              <div className="mt-4">
                <p className="text-base font-medium font-mono md:text-lg text-accent">- Every Certificate Earned</p>
              </div>
            </div>
          </div>
